...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Novo boleto</div>
                                <div class="card-body">
                    <form method="POST" action="{{ route('bills.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="expiredate" type="date" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="expiredate" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="brlamount" type="text" class="form-control" name="brlamount" required>
                            </div>
                                <label for="cryptorate" class="col-md-2 col-form-label text-md-right">{{ __('Cotação BTC') }}
                                </label>

                            <div class="col-md-2">
                                <input readonly id="cryptorate" type="readonly" class="form-control" name="cryptorate" value="{{$cotacao}}">
                            </div>
                        </div>
                             <div class="form-group row">
